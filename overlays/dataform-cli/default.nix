...
let
  sources = {
    ...
    "parse-duration-1.1.1" = {
      ...
      version = "1.1.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/parse-duration/-/parse-duration-1.1.1.tgz";
        sha512 = "27m0hKqcGzYFGtrZ1FPSNuAUi1mvqYIUjHHIgYYAc+4wcj7t2o7Qj3X4s7THMOYyeTcFjmKUZu0yJG2oE947bw==";
      };
    };
    "path-key-3.1.1" = {
      name = "path-key";
